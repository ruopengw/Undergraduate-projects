...
int main(int argc, char *argv[])
{
  ...
  /* STUDENT CODE START HERE. */		
            ...
            num = ((immediateValue & 0xFFF) << LW_IMM_SHIFT) | (atoi(arg1) << RS1_SHIFT) | LW_FUNC3<<FUNCT3_SHIFT | (atoi(arg0) << RD_SHIFT) | LW_OP;
        }
            ...
            if (isNumber(arg2))
                ...
                immediateValue = get_label_address(arg2);
            num = ((immediateValue & 0xFE0) << LW_IMM_SHIFT) | (atoi(arg0) << RS2_SHIFT) | (atoi(arg1) << RS1_SHIFT) | SW_FUNC3<<FUNCT3_SHIFT | ((immediateValue & 0x1F) << RD_SHIFT) | SW_OP;
        }
            ...
            num = ((immediateValue & 0x1000) << 19) | ((immediateValue & 0x7E0) << 20) | (atoi(arg1) << RS2_SHIFT) | (atoi(arg0) << RS1_SHIFT) | BEQ_FUNC3<<FUNCT3_SHIFT | ((immediateValue & 0x1E) << 7) | ((immediateValue & 0x800) >> 4) | BEQ_OP;
        }
        else if (!strcmp(opcode, "addi")) { //I
            num = ((atoi(arg2) & 0xFFF) << ADDI_IMM_SHIFT) | (atoi(arg1) << RS1_SHIFT) | ADDI_FUNC3<<FUNCT3_SHIFT | (atoi(arg0) << RD_SHIFT) | ADDI_OP;
        }
